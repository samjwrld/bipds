    ...
    <div className="bg-slate-50 dark:bg-slate-950 min-h-screen pt-24 pb-20 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-20">
          <h1 className="text-5xl font-display font-bold text-slate-900 dark:text-white mb-6">For <span className="text-red-600 dark:text-red-500">Institutions</span></h1>
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center mb-24">
          <div>
            <h2 className="text-4xl font-display font-bold text-slate-900 dark:text-white mb-6 leading-tight">
              Transforming Academic Research into <span className="text-red-600 dark:text-red-500">Commercial Assets.</span>
            </h2>
            ...
            <div className="space-y-4 mb-10">
              {[
                ...
                <div key={idx} className="flex items-center text-slate-700 dark:text-slate-300 font-medium">
                  <CheckCircle2 className="w-5 h-5 text-green-500 mr-3 flex-shrink-0" />
                  {item}
                </div>
              ))}
            </div>
            <Link to="/consultation" className="bg-slate-900 dark:bg-red-600 text-white px-8 py-4 rounded-full font-bold hover:bg-red-600 dark:hover:bg-red-500 transition-colors inline-flex items-center shadow-lg">
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-8 -right-8 bg-white dark:bg-slate-900 p-6 rounded-2xl shadow-xl max-w-xs border border-slate-100 dark:border-slate-800 hidden md:block">
              <div className="flex items-center mb-3">
                <div className="w-12 h-12 bg-red-50 dark:bg-red-950/60 rounded-full flex items-center justify-center mr-4">
                  <GraduationCap className="w-6 h-6 text-red-600 dark:text-red-400" />
                </div>
                <div>
                  <div className="font-bold text-slate-900 dark:text-white text-lg">50+ Partners</div>
                  <div className="text-sm text-slate-500 dark:text-slate-400">Leading Colleges</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-24">
          {[
            ...
            <div key={idx} className="bg-white dark:bg-slate-900 p-8 rounded-3xl shadow-sm border border-slate-100 dark:border-slate-800 hover:shadow-lg transition-all">
        ...
        {/* Trusted By Marquee */}
        <div className="mb-24 -mx-6 lg:-mx-8">
          <BrandMarquee />
        </div>
